    ...
    <aside class="aside-md bg-white b-r">
        <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
                <form class="form-horizontal" id="edit_form" action=<c:choose> <c:when test="${goodsCategory!=null}">"${BASE_URL}/goodsCategory/edit"</c:when><c:otherwise>"${BASE_URL}/goodsCategory/add"</c:otherwise></c:choose> method="post">
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">一级分类名称</label>
                        <div class="col-sm-4">
...
<script src="${STATIC_URL}/modules/goods/js/category.edit.js" type="text/javascript"></script>
<!-- / modal - 编辑-->