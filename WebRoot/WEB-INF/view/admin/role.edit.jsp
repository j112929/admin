    ...
    <aside class="aside-md bg-white b-r">
        <section class="vbox">
            <header class="b-b header">
                <p class="h4"> <c:choose> <c:when test="${adminRole!=null}">编辑</c:when><c:otherwise>添加</c:otherwise></c:choose></p>
            </header>
...
<%--  
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							...
							<label class="checkbox-inline p-left-0"> 
								<input type="radio" name="userType" value="2" <c:if test="${adminPermission.userType == 2}">checked="checked"</c:if> />&nbsp;所有商户
							</label> 
						</div>
					</div>
 --%>
