            ...
            <header class="header bg-white b-b clearfix">
                <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                        ...
                        <a href="${BASE_URL}/whiteList/add" class="btn btn-sm btn-default load-content"><i class="fa fa-plus"></i>添加白名单</a>
                    </div>
                    <form action="${BASE_URL}/whiteList/page" id="searchForm">
...
<script src="${STATIC_URL}/modules/white/js/list.index.js" type="text/javascript"></script>