...
public class AdminUserController extends AbstractBackController {
    ...
    @ResponseBody
    public ResultTO addAdminUser(@ModelAttribute AdminUser adminUser, BindingResult result) {
        try {
    ...
    @ResponseBody
    public ResultTO editAdminUser(@ModelAttribute AdminUser adminUser, BindingResult result) {
        try {
